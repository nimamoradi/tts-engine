...
def create_hparams(hparams_string=None, verbose=False):
    ...
    hparams = tf.contrib.training.HParams(
        ...
        training_files='filelists/ljs_text_train_filelist.txt',
        validation_files='filelists/ljs_text_val_filelist.txt',
        test_files='filelists/ljs_text_test_filelist.txt',
